...
public final class SecurityConstants {
    ...
    public static final RuntimePermission GLOBAL_CACHE_INVALIDATION_PERMISSION =
            new RuntimePermission("globalCacheInvalidationPermission");

    public static final RuntimePermission SET_GLOBAL_DEFAULT_VALUE_PERMISSION =
            new RuntimePermission("setGlobalDefaultValuePermission");
