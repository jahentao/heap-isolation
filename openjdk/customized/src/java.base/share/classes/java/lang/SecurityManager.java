...
public class SecurityManager {
    ...
    public void checkGlobalCacheInvalidation() {
        checkPermission(SecurityConstants.GLOBAL_CACHE_INVALIDATION_PERMISSION);
    }

    public void checkSetGlobalDefaultValue() {
        checkPermission(SecurityConstants.SET_GLOBAL_DEFAULT_VALUE_PERMISSION);
    }
